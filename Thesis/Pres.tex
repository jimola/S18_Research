...
\begin{tikzpicture}
	...
	\node [above=-0.5em of input2] (In2) {$D$};
...
\node [above right=-0.5pt of {(4.3, 1.1)}, outer sep=2pt, fill=white] {2};
\filldraw (4.4,0.9) circle[radius=1.5pt];
\node [below right=-0.5pt of {(4.4, 0.9)}, outer sep=2pt, fill=white] {1};
\filldraw (3.1, 2.9) circle[radius=1.5pt];
\node [above right=-0.5pt of {(3.1, 2.9)}, outer sep=2pt, fill=white] {3};
\filldraw[black] (0.9, 3.9) circle[radius=1.5pt];
\node [above right=-0.5pt of {(0.9, 3.9)}, outer sep=2pt, fill=white] {5};
\end{tikzpicture}
\end{frame}
...
\filldraw (3.1, 2.9) circle[radius=1.5pt];
\node [above right=-0.5pt of {(3.1, 2.9)}, outer sep=2pt, fill=white] {3};
\filldraw[blue] (3.1, 3.9) circle[radius=1.5pt]; 
\node [blue, above right=-0.5pt of {(3.1, 3.9)}, outer sep=2pt] {Me :)};
\filldraw[black] (0.9, 3.9) circle[radius=1.5pt];
\node [above right=-0.5pt of {(0.9, 3.9)}, outer sep=2pt, fill=white] {5};
\end{tikzpicture}
\end{frame}
